...
class DatabaseAndProgrammesModel
{
    ...
    public function getDatabaseAndProgrammesByCatergory($article_type, $categories, $published)
    {
        $data = DB::connection('mysql2')
    ...
    public function getCategory($category_type, $published)
    {
        $data = DB::connection('mysql2')
                ->table('categories')
                ->select('*')
